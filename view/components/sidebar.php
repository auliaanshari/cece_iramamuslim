    ...
    <div class="offcanvas-body p-0">
        ...
        <div class="sidenav-wrapper">
            ...
            <div class="sidenav-profile bg-gradient">
                ...
                <!-- User Thumbnail -->
                <div class="user-profile"><img src="../html/dist/img/bg-img/2.jpg" alt=""></div>
                <!-- User Info -->
                <div class="user-info">
                    <h6 class="user-name mb-0">IRAMA MUSLIM</h6><span>Bulakan, Tj Gadang</span>
                </div>
            </div>
            <!-- Sidenav Nav -->
            ...
            <div class="copyright-info">
                <p>2021 &copy; Made by<a href="#">Pemuda Kreatif</a></p>
            </div>
        </div>
    </div>
</div>